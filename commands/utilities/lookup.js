	...
	async execute(interaction) {
		...
		if (blaster == undefined) {
			...
			switch (blaster.tier) {
				...
				case 2: await interaction.reply('The **' + blaster.name + '** is a tier **2** blaster. It can only be used during the day and during missions.'); break;
				case 3: await interaction.reply('The **' + blaster.name + '** is a tier **3** blaster. It can only be used at missions.'); break;
